...
class GL43 extends GL42
{
    ...
    /**
     * {@see GL46::glDispatchCompute} launches one or more compute work
     * groups. Each work group is processed by the active program object for
     * the compute shader stage. While the individual shader invocations
     * within a work group are executed as a unit, work groups are executed
     * completely independently and in unspecified order. $num_groups_x,
     * $num_groups_y and $num_groups_z specify the number of local work
     * groups that will be dispatched in the X, Y and Z dimensions,
     * respectively.
     *
    ...
    /**
     * {@see GL46::glDispatchComputeIndirect} launches one or more compute
     * work groups using parameters stored in the buffer object currently
     * bound to the {@see GL46::GL_DISPATCH_INDIRECT_BUFFER} target. Each
     * work group is processed by the active program object for the compute
     * shader stage. While the individual shader invocations within a work
     ...
     * {@see GL46::GL_DISPATCH_INDIRECT_BUFFER} target at which the
     ...
     * </code>
     *
     * A call to {@see GL46::glDispatchComputeIndirect} is equivalent,
     * assuming no errors are generated, to:
     *
     * <code>
     *     cmd = (const DispatchIndirectCommand  *)indirect;
     *     glDispatchCompute(cmd->num_groups_x, cmd->num_groups_y,
     * cmd->num_groups_z);
     * </code>
     *
     * Unlike {@see GL46::glDispatchCompute}, no error is generated if any of
     * the `num_groups_x`, `num_groups_y` or `num_groups_z` members of the
     * `DispatchIndirectCommand` is larger than the value of
     * {@see GL46::GL_MAX_COMPUTE_WORK_GROUP_COUNT} for the corresponding
    ...
    /**
     * {@see GL46::glCopyImageSubData} may be used to copy data from one
     * image (i.e. texture or renderbuffer) to another.
     * {@see GL46::glCopyImageSubData} does not perform general-purpose
     * conversions such as scaling, resizing, blending, color-space, or
     * format conversions. It should be considered to operate in a manner
     * similar to a CPU memcpy. CopyImageSubData can copy between images with
     * different internal formats, provided the formats are compatible.
     *
     * {@see GL46::glCopyImageSubData} also allows copying between certain
     * types of compressed and uncompressed internal formats. This copy does
     * not perform on-the-fly compression or decompression. When copying from
     * an uncompressed internal format to a compressed internal format, each
     ...
     * $target parameter. If $target is {@see GL46::GL_RENDERBUFFER}, the
     * name is interpreted as the name of a renderbuffer object. If the
     * target parameter is a texture target, the name is interpreted as a
     * texture object. All non-proxy texture targets are accepted, with the
     * exception of {@see GL46::GL_TEXTURE_BUFFER} and the cubemap face
     * selectors.
     *
     ...
     * $srcWidth-wide by $srcHeight-high by $srcDepth-deep rectangular
     ...
     * The source and destination subregions must be contained entirely
     ...
     * texels touched in the compressed image will be a factor of the block
     * size larger than in the uncompressed image.
     *
     * Slices of a {@see GL46::GL_TEXTURE_1D_ARRAY},
     * {@see GL46::GL_TEXTURE_2D_ARRAY},
     * {@see GL46::GL_TEXTURE_CUBE_MAP_ARRAY} {@see GL46::GL_TEXTURE_3D} and
     * faces of {@see GL46::GL_TEXTURE_CUBE_MAP} are all compatible provided
     * they share a compatible internal format, and multiple slices or faces
     * may be copied between these objects with a single call by specifying
     * the starting slice with $srcZ and $dstZ, and the number of slices to
     * be copied with $srcDepth. Cubemap textures always have six faces which
     * are selected by a zero-based face index.
     *
     * For the purposes of CopyImageSubData, two internal formats are
     * considered compatible if any of the following conditions are met:
     * the formats are the same,     the formats are considered compatible
     * according to the compatibility rules used for texture views as defined
     * in section 3.9.X. In particular, if both internal formats are listed
     * in the same entry of Table 3.X.2, they are considered compatible, or
     *   one format is compressed and the other is uncompressed and Table
     * 4.X.1 lists the two formats in the same row.    If the formats are not
     * compatible, an INVALID_OPERATION error is generated.
     *
     * | 64-bit  | {@see GL46::GL_RGBA32UI}, {@see GL46::GL_RGBA32I},
     * {@see GL46::GL_RGBA32F}                                                                                                                             | {@see GL46::GL_COMPRESSED_RGBA_S3TC_DXT3_EXT},
     * {@see GL46::GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT},
     * {@see GL46::GL_COMPRESSED_RGBA_S3TC_DXT5_EXT},
     * {@see GL46::GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT},
     * {@see GL46::GL_COMPRESSED_RG_RGTC2},
     * {@see GL46::GL_COMPRESSED_SIGNED_RG_RGTC2},
     * {@see GL46::GL_COMPRESSED_RGBA_BPTC_UNORM},
     * {@see GL46::GL_COMPRESSED_SRGB_ALPHA_BPTC_UNORM},
     * {@see GL46::GL_COMPRESSED_RGB_BPTC_SIGNED_FLOAT},
     * {@see GL46::GL_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT} |
     * | 128-bit | {@see GL46::GL_RGBA16UI}, {@see GL46::GL_RGBA16I},
     * {@see GL46::GL_RGBA16F}, {@see GL46::GL_RG32F},
     * {@see GL46::GL_RG32UI}, {@see GL46::GL_RG32I}, {@see GL46::GL_RGBA16},
     * {@see GL46::GL_RGBA16_SNORM} | {@see GL46::GL_COMPRESSED_RGB_S3TC_DXT1_EXT},
     * {@see GL46::GL_COMPRESSED_SRGB_S3TC_DXT1_EXT},
     * {@see GL46::GL_COMPRESSED_RGBA_S3TC_DXT1_EXT},
     * {@see GL46::GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT},
     * {@see GL46::GL_COMPRESSED_RED_RGTC1},
     * {@see GL46::GL_COMPRESSED_SIGNED_RED_RGTC1}                                                                                                                                                                                                          |
    ...
    /**
     * {@see GL46::glFramebufferParameteri} and
     * {@see GL46::glNamedFramebufferParameteri} modify the value of the
     * parameter named $pname in the specified framebuffer object. There are
     * no modifiable parameters of the default draw and read framebuffer, so
     * they are not valid targets of these commands.
     *
     * For {@see GL46::glFramebufferParameteri}, the framebuffer object is
     ...
     *
     * For {@see GL46::glNamedFramebufferParameteri}, $framebuffer is the
     ...
     *    assumed with for a framebuffer object with no
     *    attachments. If a framebuffer has attachments then the width of those
     *    attachments is used, otherwise the value of
     *    {@see GL46::GL_FRAMEBUFFER_DEFAULT_WIDTH} is used for the framebuffer.
     *    $param must be greater than or equal to zero and less than or equal to
     *    the value of {@see GL46::GL_MAX_FRAMEBUFFER_WIDTH}.
     *
     *  - {@see GL46::GL_FRAMEBUFFER_DEFAULT_HEIGHT}: $param specifies the
     *    assumed height for a framebuffer object with no
     *    attachments. If a framebuffer has attachments then the height of those
     *    attachments is used, otherwise the value of
     *    {@see GL46::GL_FRAMEBUFFER_DEFAULT_HEIGHT} is used for the
     *    framebuffer. $param must be greater than or equal to zero and less
     *    than or equal to the value of {@see GL46::GL_MAX_FRAMEBUFFER_HEIGHT}.
     *
     *  - {@see GL46::GL_FRAMEBUFFER_DEFAULT_LAYERS}: $param specifies the
     *    assumed number of layers for a framebuffer
     *    object with no attachments. If a framebuffer has attachments then the
     *    layer count of those attachments is used, otherwise the value of
     *    {@see GL46::GL_FRAMEBUFFER_DEFAULT_LAYERS} is used for the
     *    framebuffer. $param must be greater than or equal to zero and less
     *    than or equal to the value of {@see GL46::GL_MAX_FRAMEBUFFER_LAYERS}.
     *
     *  - {@see GL46::GL_FRAMEBUFFER_DEFAULT_SAMPLES}: $param specifies the
     *    assumed number of samples in a framebuffer
     *    object with no attachments. If a framebuffer has attachments then the
     *    sample count of those attachments is used, otherwise the value of
     *    {@see GL46::GL_FRAMEBUFFER_DEFAULT_SAMPLES} is used for the
     *    framebuffer. $param must be greater than or equal to zero and less
     *    than or equal to the value of {@see GL46::GL_MAX_FRAMEBUFFER_SAMPLE}.
     *
     *  - {@see GL46::GL_FRAMEBUFFER_DEFAULT_FIXED_SAMPLE_LOCATIONS}: $param
     *    specifies whether the framebuffer should assume identical
     *    sample locations and the same number of samples for all texels in the
     *    virtual image. If $param is zero, then the implementation may vary the
     *    position or the count of samples within the virtual image from pixel
     *    to pixel, otherwise it will use the same sample position and count for
     *    all pixels in the virtual image.
     *
    ...
    /**
     * {@see GL46::glGetInternalformativ} and
     * {@see GL46::glGetInternalformati64v} retrieve information about
     * implementation-dependent support for internal formats. $target
     * indicates the target with which the internal format will be used and
     * must be one of {@see GL46::GL_RENDERBUFFER},
     * {@see GL46::GL_TEXTURE_2D_MULTISAMPLE}, or
     * {@see GL46::GL_TEXTURE_2D_MULTISAMPLE_ARRAY}, corresponding to usage
     * as a renderbuffer, two-dimensional multisample texture or
     ...
     * pointer specified in $params. No more than $bufSize integers will be
     * written to this memory.
     *
     * If $pname is {@see GL46::GL_NUM_SAMPLE_COUNTS}, the number of sample
     * counts that would be returned by querying {@see GL46::GL_SAMPLES} will
     * be returned in $params.
     *
     * If $pname is {@see GL46::GL_SAMPLES}, the sample counts supported for
     * $internalformat and $target are written into $params in descending
     * numeric order. Only positive values are returned. Querying
     * {@see GL46::GL_SAMPLES} with $bufSize of one will return just the
     * maximum supported number of samples for this format. The maximum value
     * in {@see GL46::GL_SAMPLES} is guaranteed to be at least the lowest of
     * the following:    The value of {@see GL46::GL_MAX_INTEGER_SAMPLES} if
     * $internalformat is a signed or unsigned integer format.     The value
     * of {@see GL46::GL_MAX_DEPTH_TEXTURE_SAMPLES} if $internalformat is a
     * depth- or stencil-renderable format and $target is
     * {@see GL46::GL_TEXTURE_2D_MULTISAMPLE},
     * {@see GL46::GL_TEXTURE_2D_MULTISAMPLE_ARRAY}.     The value of
     * {@see GL46::GL_MAX_COLOR_TEXTURE_SAMPLES} if $internalformat is a
     * color-renderable format and $target is
     * {@see GL46::GL_TEXTURE_2D_MULTISAMPLE} or
     * {@see GL46::GL_TEXTURE_2D_MULTISAMPLE_ARRAY}.    The value of
     * {@see GL46::GL_MAX_SAMPLES}.
     *
     * If $pname is {@see GL46::GL_INTERNALFORMAT_SUPPORTED}, $params is set
     * to {@see GL46::GL_TRUE} if $internalformat is a supported internal
     * format for $target and to {@see GL46::GL_FALSE} otherwise.
     *
     * If $pname is {@see GL46::GL_INTERNALFORMAT_PREFERRED}, $params is set
     * to {@see GL46::GL_TRUE} if $internalformat is an format for $target
     * that is preferred by the implementation and to {@see GL46::GL_FALSE}
     * otherwise.
     *
     * If $pname is {@see GL46::GL_INTERNALFORMAT_RED_SIZE},
     * {@see GL46::GL_INTERNALFORMAT_GREEN_SIZE},
     * {@see GL46::GL_INTERNALFORMAT_BLUE_SIZE},
     * {@see GL46::GL_INTERNALFORMAT_ALPHA_SIZE},
     * {@see GL46::GL_INTERNALFORMAT_DEPTH_SIZE},
     * {@see GL46::GL_INTERNALFORMAT_STENCIL_SIZE}, or
     * {@see GL46::GL_INTERNALFORMAT_SHARED_SIZE} then $params is set to the
     * actual resolutions that would be used for storing image array
     * components for the resource for the red, green, blue, alpha, depth,
     * stencil and shared channels respectively. If $internalformat is a
     * compressed internal format, then $params is set to the component
     * resolution of an uncompressed internal format that produces an image
     * of roughly the same quality as the compressed algorithm. If the
     * internal format is unsupported, or if a particular component is not
     * present in the format, 0 is written to $params.
     *
     * If $pname is {@see GL46::GL_INTERNALFORMAT_RED_TYPE},
     * {@see GL46::GL_INTERNALFORMAT_GREEN_TYPE},
     * {@see GL46::GL_INTERNALFORMAT_BLUE_TYPE},
     * {@see GL46::GL_INTERNALFORMAT_ALPHA_TYPE},
     * {@see GL46::GL_INTERNALFORMAT_DEPTH_TYPE}, or
     * {@see GL46::GL_INTERNALFORMAT_STENCIL_TYPE} then $params is set to a
     * token identifying the data type used to store the respective
     * component. If the $internalformat represents a compressed internal
     * format then the types returned specify how components are interpreted
     * after decompression.
     *
     * If $pname is {@see GL46::GL_MAX_WIDTH}, {@see GL46::GL_MAX_HEIGHT},
     * {@see GL46::GL_MAX_DEPTH}, or {@see GL46::GL_MAX_LAYERS} then $pname
     * is filled with the maximum width, height, depth or layer count for
     * textures with internal format $internalformat, respectively. If $pname
     * is {@see GL46::GL_MAX_COMBINED_DIMENSIONS} then $pname is filled with
     * the maximum combined dimensions of a texture of the specified internal
     * format.
     *
     * If $pname is {@see GL46::GL_COLOR_COMPONENTS} then $params is set to
     * the value {@see GL46::GL_TRUE} if the internal format contains any
     * color component (i.e., red, green, blue or alpha) and to
     * {@see GL46::GL_FALSE} otherwise. If $pname is
     * {@see GL46::GL_DEPTH_COMPONENTS} or {@see GL46::GL_STENCIL_COMPONENTS}
     * then $params is set to {@see GL46::GL_TRUE} if the internal format
     * contains a depth or stencil component, respectively, and to
     * {@see GL46::GL_FALSE} otherwise.
     *
     * If $pname is {@see GL46::GL_COLOR_RENDERABLE},
     * {@see GL46::GL_DEPTH_RENDERABLE} or {@see GL46::GL_STENCIL_RENDERABLE}
     * then $params is set to {@see GL46::GL_TRUE} if the specified internal
     * format is color, depth or stencil renderable, respectively, and to
     * {@see GL46::GL_FALSE} otherwise.
     *
     * If $pname is {@see GL46::GL_FRAMEBUFFER_RENDERABLE} or
     * {@see GL46::GL_FRAMEBUFFER_RENDERABLE_LAYERED} then $params is set to
     * one of {@see GL46::GL_FULL_SUPPORT}, {@see GL46::GL_CAVEAT_SUPPORT} or
     * {@see GL46::GL_NONE} to indicate that framebuffer attachments (layered
     * attachments in the case of
     * {@see GL46::GL_FRAMEBUFFER_RENDERABLE_LAYERED}) with that internal
     * format are either renderable with no restrictions, renderable with
     * some restrictions or not renderable at all.
     *
     * If $pname is {@see GL46::GL_FRAMEBUFFER_BLEND}, $params is set to
     * {@see GL46::GL_TRUE} to indicate that the internal format is supported
     * for blending operations when attached to a framebuffer, and to
     * {@see GL46::GL_FALSE} otherwise.
     *
     * If $pname is {@see GL46::GL_READ_PIXELS} then $params is set to
     * {@see GL46::GL_FULL_SUPPORT}, {@see GL46::GL_CAVEAT_SUPPORT} or
     * {@see GL46::GL_NONE} to that either full support, limited support or
     * no support at all is supplied for reading pixels from framebuffer
     * attachments in the specified internal format.
     *
     * If $pname is {@see GL46::GL_READ_PIXELS_FORMAT} or
     * {@see GL46::GL_READ_PIXELS_TYPE} then $params is filled with the
     * format or type, respectively, most recommended to obtain the highest
     * image quality and performance. For {@see GL46::GL_READ_PIXELS_FORMAT},
     * the value returned in $params is a token that is accepted for the
     * $format argument to {@see GL46::glReadPixels}. For
     * {@see GL46::GL_READ_PIXELS_TYPE}, the value returned in $params is a
     * token that is accepted for the $type argument to
     * {@see GL46::glReadPixels}.
     *
     * If $pname is {@see GL46::GL_TEXTURE_IMAGE_FORMAT} or
     * {@see GL46::GL_TEXTURE_IMAGE_TYPE} then $params is filled with the
     * implementation-recommended format or type to be used in calls to
     * {@see GL46::glTexImage2D} and other similar functions. For
     * {@see GL46::GL_TEXTURE_IMAGE_FORMAT}, $params is filled with a token
     * suitable for use as the $format argument to {@see GL46::glTexImage2D}.
     * For {@see GL46::GL_TEXTURE_IMAGE_TYPE}, $params is filled with a token
     * suitable for use as the $type argument to {@see GL46::glTexImage2D}.
     *
     * If $pname is {@see GL46::GL_GET_TEXTURE_IMAGE_FORMAT} or
     * {@see GL46::GL_GET_TEXTURE_IMAGE_TYPE} then $params is filled with the
     * implementation-recommended format or type to be used in calls to
     * {@see GL46::glGetTexImage} and other similar functions. For
     * {@see GL46::GL_GET_TEXTURE_IMAGE_FORMAT}, $params is filled with a
     * token suitable for use as the $format argument to
     * {@see GL46::glGetTexImage}. For
     * {@see GL46::GL_GET_TEXTURE_IMAGE_TYPE}, $params is filled with a token
     * suitable for use as the $type argument to {@see GL46::glGetTexImage}.
     *
     * If $pname is {@see GL46::GL_MIPMAP} then $pname is set to
     * {@see GL46::GL_TRUE} to indicate that the specified internal format
     * supports mipmaps and to {@see GL46::GL_FALSE} otherwise.
     *
     * If $pname is {@see GL46::GL_GENERATE_MIPMAP} or
     * {@see GL46::GL_AUTO_GENERATE_MIPMAP} then $params is indicates the
     * level of support for manual or automatic mipmap generation for the
     * specified internal format, respectively. Returned values may be one of
     * {@see GL46::GL_FULL_SUPPORT}, {@see GL46::GL_CAVEAT_SUPPORT} and
     * {@see GL46::GL_NONE} to indicate either full support, limited support
     * or no support at all.
     *
     * If $pname is {@see GL46::GL_COLOR_ENCODING} then the color encoding
     * for the resource is returned in $params. Possible values for color
     * buffers are {@see GL46::GL_LINEAR} or {@see GL46::GL_SRGB}, for linear
     ...
     *
     * If $pname is {@see GL46::GL_SRGB_READ}, or {@see GL46::GL_SRGB_WRITE}
     * then $params indicates the level of support for reading and writing to
     * sRGB encoded images, respectively. For {@see GL46::GL_SRGB_READ},
     * support for converting from sRGB colorspace on read operations is
     * returned in $params and for {@see GL46::GL_SRGB_WRITE}, support for
     * converting to sRGB colorspace on write operations to the resource is
     * returned in $params. $params may be set to
     * {@see GL46::GL_FULL_SUPPORT}, {@see GL46::GL_CAVEAT_SUPPORT}, or
     * {@see GL46::GL_NONE} to indicate full support, limited support or no
     * support at all, respecitively.
     *
     * If $pname is {@see GL46::GL_FILTER} the $params is set to either
     * {@see GL46::GL_TRUE} or {@see GL46::GL_FALSE} to indicate support or
     * lack thereof for filter modes other than {@see GL46::GL_NEAREST} or
     * {@see GL46::GL_NEAREST_MIPMAP} for the specified internal format.
     *
     * If $pname is {@see GL46::GL_VERTEX_TEXTURE},
     * {@see GL46::GL_TESS_CONTROL_TEXTURE},
     * {@see GL46::GL_TESS_EVALUATION_TEXTURE},
     * {@see GL46::GL_GEOMETRY_TEXTURE}, {@see GL46::GL_FRAGMENT_TEXTURE}, or
     * {@see GL46::GL_COMPUTE_TEXTURE}, then the value written to $params
     * indicates support for use of the resource as a source of texturing in
     * the vertex, tessellation control, tessellation evaluation, geometry,
     * fragment and compute shader stages, respectively. $params may be set
     * to {@see GL46::GL_FULL_SUPPORT}, {@see GL46::GL_CAVEAT_SUPPORT} or
     * {@see GL46::GL_NONE} to indicate full support, limited support or no
     * support at all, respectively.
     *
     * If $pname is {@see GL46::GL_TEXTURE_SHADOW},
     * {@see GL46::GL_TEXTURE_GATHER} or
     * {@see GL46::GL_TEXTURE_GATHER_SHADOW} then the value written to
     * $params indicates the level of support for using the resource with a
     * shadow sampler, in gather operations or as a shadow sampler in gather
     * operations, respectively. Returned values may be
     * {@see GL46::GL_FULL_SUPPORT}, {@see GL46::GL_CAVEAT_SUPPORT} or
     * {@see GL46::GL_NONE} to indicate full support, limited support or no
     * support at all, respectively.
     *
     * If $pname is {@see GL46::GL_SHADER_IMAGE_LOAD},
     * {@see GL46::GL_SHADER_IMAGE_STORE} or
     * {@see GL46::GL_SHADER_IMAGE_ATOMIC} then the value returned in $params
     ...
     * support at all, respectively.
     *
     * If $pname is {@see GL46::GL_IMAGE_TEXEL_SIZE} then the size of a texel
     * when the resource when used as an image texture is returned in
     * $params. If the resource is not supported for image textures zero is
     * returned.
     *
     * If $pname is {@see GL46::GL_IMAGE_COMPATIBILITY_CLASS} then the
     * compatibility class of the resource when used as an image texture is
     * returned in $params. The possible values returned are
     * {@see GL46::GL_IMAGE_CLASS_4_X_32},
     * {@see GL46::GL_IMAGE_CLASS_2_X_32},
     * {@see GL46::GL_IMAGE_CLASS_1_X_32},
     * {@see GL46::GL_IMAGE_CLASS_4_X_16},
     * {@see GL46::GL_IMAGE_CLASS_2_X_16},
     * {@see GL46::GL_IMAGE_CLASS_1_X_16}, {@see GL46::GL_IMAGE_CLASS_4_X_8},
     * {@see GL46::GL_IMAGE_CLASS_2_X_8}, {@see GL46::GL_IMAGE_CLASS_1_X_8},
     * {@see GL46::GL_IMAGE_CLASS_11_11_10}, and
     * {@see GL46::GL_IMAGE_CLASS_10_10_10_2}, which correspond to the 4x32,
     * 2x32, 1x32, 4x16, 2x16, 1x16, 4x8, 2x8, 1x8, the class (a) 11/11/10
     * packed floating-point format, and the class (b) 10/10/10/2 packed
     * formats, respectively. If the resource is not supported for image
     * textures, {@see GL46::GL_NONE} is returned.
     *
     * If $pname is {@see GL46::GL_IMAGE_PIXEL_FORMAT} or
     * {@see GL46::GL_IMAGE_PIXEL_TYPE} then the pixel format or type of the
     * resource when used as an image texture is returned in $params,
     * respectively. In either case, the resource is not supported for image
     * textures {@see GL46::GL_NONE} is returned.
     *
     * If $pname is {@see GL46::GL_IMAGE_FORMAT_COMPATIBILITY_TYPE}, the
     * matching criteria use for the resource when used as an image textures
     * is returned in $params. Possible values returned in $params are
     * {@see GL46::GL_IMAGE_FORMAT_COMPATIBILITY_BY_SIZE} or
     * {@see GL46::GL_IMAGE_FORMAT_COMPATIBILITY_BY_CLASS}. If the resource
     * is not supported for image textures, {@see GL46::GL_NONE} is returned.
     *
     * If $pname is {@see GL46::GL_SIMULTANEOUS_TEXTURE_AND_DEPTH_TEST} or
     * {@see GL46::GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_TEST}, support for
     * using the resource both as a source for texture sampling while it is
     * bound as a buffer for depth or stencil test, respectively, is written
     * to $params. Possible values returned are {@see GL46::GL_FULL_SUPPORT},
     * {@see GL46::GL_CAVEAT_SUPPORT}, or {@see GL46::GL_NONE} to indicate
     ...
     * {@see GL46::GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_WRITE}, support for
     * using the resource both as a source for texture sampling while
     * performing depth or stencil writes to the resources, respectively, is
     * written to $params. Possible values returned are
     * {@see GL46::GL_FULL_SUPPORT}, {@see GL46::GL_CAVEAT_SUPPORT}, or
     * {@see GL46::GL_NONE} to indicate full support, limited support or no
     * support at all. If the resource or operation is not supported,
     * {@see GL46::GL_NONE} is returned.
     *
     * If $pname is {@see GL46::GL_TEXTURE_COMPRESSED} then
     * {@see GL46::GL_TRUE} is returned in $params if $internalformat is a
     * compressed internal format. {@see GL46::GL_FALSE} is returned in
     * $params otherwise.
     *
     * If $pname is {@see GL46::GL_TEXTURE_COMPRESSED_BLOCK_WIDTH},
     * {@see GL46::GL_TEXTURE_COMPRESSED_BLOCK_HEIGHT} or
     * {@see GL46::GL_TEXTURE_COMPRESSED_BLOCK_SIZE} then the width, height
     * or total size, respectively of a block (in basic machine units) is
     * returned in $params. If the internal format is not compressed, or the
     * resource is not supported, 0 is returned.
     *
     * If $pname is {@see GL46::GL_CLEAR_BUFFER}, the level of support for
     * using the resource with {@see GL46::glClearBufferData} and
     * {@see GL46::glClearBufferSubData} is returned in $params. Possible
     * values returned are {@see GL46::GL_FULL_SUPPORT},
     * {@see GL46::GL_CAVEAT_SUPPORT}, or {@see GL46::GL_NONE} to indicate
     * full support, limited support or no support at all, respectively. If
     * the resource or operation is not supported, {@see GL46::GL_NONE} is
     * returned.
     *
     * If $pname is {@see GL46::GL_TEXTURE_VIEW}, the level of support for
     * using the resource with the {@see GL46::glTextureView} command is
     * returned in $params. Possible values returned are
     * {@see GL46::GL_FULL_SUPPORT}, {@see GL46::GL_CAVEAT_SUPPORT}, or
     * {@see GL46::GL_NONE} to indicate full support, limited support or no
     * support at all, respectively. If the resource or operation is not
     * supported, {@see GL46::GL_NONE} is returned.
     *
     * If $pname is {@see GL46::GL_VIEW_COMPATIBILITY_CLASS} then the
     * compatibility class of the resource when used as a texture view is
     * returned in $params. The possible values returned are
     * {@see GL46::GL_VIEW_CLASS_128_BITS},
     * {@see GL46::GL_VIEW_CLASS_96_BITS},
     * {@see GL46::GL_VIEW_CLASS_64_BITS},
     * {@see GL46::GL_VIEW_CLASS_48_BITS},
     * {@see GL46::GL_VIEW_CLASS_32_BITS},
     * {@see GL46::GL_VIEW_CLASS_24_BITS},
     * {@see GL46::GL_VIEW_CLASS_16_BITS}, {@see GL46::GL_VIEW_CLASS_8_BITS},
     * {@see GL46::GL_VIEW_CLASS_S3TC_DXT1_RGB},
     * {@see GL46::GL_VIEW_CLASS_S3TC_DXT1_RGBA},
     * {@see GL46::GL_VIEW_CLASS_S3TC_DXT3_RGBA},
     * {@see GL46::GL_VIEW_CLASS_S3TC_DXT5_RGBA},
     * {@see GL46::GL_VIEW_CLASS_RGTC1_RED},
     * {@see GL46::GL_VIEW_CLASS_RGTC2_RG},
     * {@see GL46::GL_VIEW_CLASS_BPTC_UNORM}, and
     * {@see GL46::GL_VIEW_CLASS_BPTC_FLOAT}.
     *
     * If $pname is {@see GL46::GL_CLEAR_TEXTURE} then the presence of
     * support for using the {@see GL46::glClearTexImage} and
     * {@see GL46::glClearTexSubImage} commands with the resource is written
     * to $params. Possible values written are {@see GL46::GL_FULL_SUPPORT},
     * {@see GL46::GL_CAVEAT_SUPPORT}, or {@see GL46::GL_NONE} to indicate
     * full support, limited support or no support at all, respectively. If
     * the resource or operation is not supported, {@see GL46::GL_NONE} is
     * returned.
    ...
    /**
     * {@see GL46::glInvalidateTexSubImage} invalidates all or part of a
     * texture image. $texture and $level indicated which texture image is
     * being invalidated. After this command, data in that subregion have
     * undefined values. $xoffset, $yoffset, $zoffset, $width, $height, and
     * $depth are interpreted as they are in {@see GL46::glTexSubImage3D}.
     * For texture targets that don't have certain dimensions, this command
     ...
     * 2 logarithm of the maximum texture width, height, or depth. $xoffset,
     * $yoffset and $zoffset must be greater than or equal to zero and be
     * less than the width, height or depth of the image, respectively.
     * Furthermore, $xoffset + $width, $yoffset + $height, and $zoffset +
     * $depth must be less than or equal to the width, height or depth of the
     * image, respectively.
     *
     * For textures of targets {@see GL46::GL_TEXTURE_RECTANGLE},
     * {@see GL46::GL_TEXTURE_BUFFER},
     * {@see GL46::GL_TEXTURE_2D_MULTISAMPLE}, or
     * {@see GL46::GL_TEXTURE_2D_MULTISAMPLE_ARRAY}, level must be zero.
     *
    ...
    /**
     * {@see GL46::glInvalidateTexSubImage} invalidates all of a texture
    ...
    /**
     * {@see GL46::glInvalidateBufferData} invalidates all of the content of
     * the data store of a buffer object. After invalidation, the content of
    ...
    /**
     * {@see GL46::glInvalidateFramebuffer} and
     * {@see GL46::glInvalidateNamedFramebufferData} invalidate the entire
     * contents of a specified set of attachments of a framebuffer.
     *
     * For {@see GL46::glInvalidateFramebuffer}, the framebuffer object is
     * that bound to $target. $target must be {@see GL46::GL_FRAMEBUFFER},
     * {@see GL46::GL_READ_FRAMEBUFFER} or {@see GL46::GL_DRAW_FRAMEBUFFER}.
     * {@see GL46::GL_FRAMEBUFFER} is equivalent to
     * {@see GL46::GL_DRAW_FRAMEBUFFER}. Default framebuffers may also be
     * invalidated if bound to $target.
     *
     * For {@see GL46::glInvalidateNamedFramebufferData}, $framebuffer is the
     * name of the framebuffer object. If $framebuffer is zero, the default
     ...
     * after execution of {@see GL46::glInvalidateFramebuffer} or
     * {@see GL46::glInvalidateNamedFramebufferData}.
     *
     * If the framebuffer object is not complete,
     * {@see GL46::glInvalidateFramebuffer} and
     * {@see GL46::glInvalidateNamedFramebufferData} may be ignored. This is
     * not an error.
     *
    ...
    /**
     * {@see GL46::glGetProgramInterfaceiv} queries the property of the
     * interface identifed by $programInterface in $program, the property
     ...
     *    active uniform blocks within
     *    $program.
     *
     *  - {@see GL46::GL_ATOMIC_COUNTER_BUFFER}: The query is targeted at the
     *    set of active atomic counter buffer
     *    binding points within $program.
     *
     *  - {@see GL46::GL_PROGRAM_INPUT}: The query is targeted at the set of
     *    active input variables used by
     *    the first shader stage of $program. If $program contains multiple
     *    shader stages then input variables from any stage other than the first
     *    will not be enumerated.
     *
     *  - {@see GL46::GL_PROGRAM_OUTPUT}: The query is targeted at the set of
     *    active output variables produced
     *    by the last shader stage of $program. If $program contains multiple
     *    shader stages then output variables from any stage other than the last
     *    will not be enumerated.
     *
     *  - {@see GL46::GL_VERTEX_SUBROUTINE}: The query is targeted at the set of
     *    active subroutines for the
     ...
     *    the set of active subroutine uniform
     *    variables used by the vertex, tessellation control, tessellation
     ...
     *    the set of output variables from the last
     *    non-fragment stage of $program that would be captured if transform
     *    feedback were active.
     *
     *  - {@see GL46::GL_BUFFER_VARIABLE}: The query is targeted at the set of
     *    active buffer variables used by
     *    $program.
     *
     *  - {@see GL46::GL_SHADER_STORAGE_BLOCK}: The query is targeted at the set
     *    of active shader storage blocks used
     *    by $program.
     *
     *  - {@see GL46::GL_TRANSFORM_FEEDBACK_BUFFER}: The query is targeted at
     *    the set of active buffer binding points to
     *    which output variables in the
     ...
     * $params.
     *
     * If $pname is {@see GL46::GL_ACTIVE_RESOURCES}, the value returned is
     * the number of resources in the active resource list for
     * $programInterface. If the list of active resources for
     * $programInterface is empty, zero is returned.
     *
     * If $pname is {@see GL46::GL_MAX_NAME_LENGTH}, the value returned is
     * the length of the longest active name string for an active resource in
     * $programInterface. This length includes an extra character for the
     * null terminator. If the list of active resources for $programInterface
     * is empty, zero is returned. It is an error to specify
     * {@see GL46::GL_MAX_NAME_LENGTH} when $programInterface is
     * {@see GL46::GL_ATOMIC_COUNTER_BUFFER}, as active atomic counter buffer
     * resources are not assigned name strings.
     *
     * If $pname is {@see GL46::GL_MAX_NUM_ACTIVE_VARIABLES}, the value
     * returned is the number of active variables belonging to the interface
     * block or atomic counter buffer resource in $programInterface with the
     * most active variables. If the list of active resources for
     * $programInterface is empty, zero is returned. When $pname is
     * {@see GL46::GL_MAX_NUM_ACTIVE_VARIABLES}, $programInterface must be
     * {@see GL46::GL_UNIFORM_BLOCK}, {@see GL46::GL_ATOMIC_COUNTER_BUFFER},
     * or {@see GL46::GL_SHADER_STORAGE_BLOCK}.
     *
     * If $pname is {@see GL46::GL_MAX_NUM_COMPATIBLE_SUBROUTINES}, the value
     ...
     * $programInterface is empty, zero is returned. When $pname is
     * {@see GL46::GL_MAX_NUM_COMPATIBLE_SUBROUTINES}, $programInterface must
     * be one of {@see GL46::GL_VERTEX_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_TESS_CONTROL_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_TESS_EVALUATION_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_GEOMETRY_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_FRAGMENT_SUBROUTINE_UNIFORM}, or
     * {@see GL46::GL_COMPUTE_SUBROUTINE_UNIFORM}.
     *
    ...
    /**
     * {@see GL46::glGetProgramResourceIndex} returns the unsigned integer
     * index assigned to a resource named $name in the interface type
     * $programInterface of program object $program.
     *
     * $program must be the name of an existing program object.
     * $programInterface is the name of the interface within $program which
     * contains the resource named $nameand must be one of the following
     * values:
     *
     *  - {@see GL46::GL_UNIFORM}: The query is targeted at the set of active
     *    uniforms within $program.
     ...
     *
     * For the interface {@see GL46::GL_TRANSFORM_FEEDBACK_VARYING}, the
     * value {@see GL46::GL_INVALID_INDEX} should be returned when querying
     * the index assigned to the special names `gl_NextBuffer`,
    ...
    /**
     * {@see GL46::glGetProgramResourceName} retrieves the name string
     * assigned to the single active resource with an index of $index in the
     * interface $programInterface of program object $program. $index must be
     * less than the number of entries in the active resource list for
     * $programInterface.
     *
     * $program must be the name of an existing program object.
     * $programInterface is the name of the interface within $program which
     ...
     * generated but no characters will be written to $name. The length of
     * the longest name string for $programInterface&gt;, including a null
     * terminator, can be queried by calling
     * {@see GL46::glGetProgramInterface} with a $pname of
     * {@see GL46::GL_MAX_NAME_LENGTH}.
     *
    ...
    /**
     * {@see GL46::glGetProgramResourceiv} returns values for multiple
     * properties of a single active resource with an index of $index in the
     * interface $programInterface of program object $program. For each
     * resource, values for $propCount properties specified by the array
     * $props are returned. $propCount may not be zero. An error is generated
     * if any value in $props is not one of the properties described
     * immediately belowor if any value in $props is not allowed for
     * $programInterface. The set of allowed $programInterface values for
     * each property can be found in the following table:
     *
     * | {@see GL46::GL_NAME_LENGTH}                          | Any except {@see GL46::GL_ATOMIC_COUNTER_BUFFER} and
     * {@see GL46::GL_TRANSFORM_FEEDBACK_BUFFER}                                                                                                                                                                                                                                                                                                                                            |
     * | {@see GL46::GL_TYPE}                                 | {@see GL46::GL_UNIFORM}, {@see GL46::GL_PROGRAM_INPUT},
     * {@see GL46::GL_PROGRAM_OUTPUT},
     * {@see GL46::GL_TRANSFORM_FEEDBACK_VARYING},
     * {@see GL46::GL_BUFFER_VARIABLE}                                                                                                                                                                                                                                                                       |
     * | {@see GL46::GL_ARRAY_SIZE}                           | {@see GL46::GL_UNIFORM}, {@see GL46::GL_BUFFER_VARIABLE},
     * {@see GL46::GL_PROGRAM_INPUT}, {@see GL46::GL_PROGRAM_OUTPUT,
     * VERTEX_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_TESS_CONTROL_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_TESS_EVALUATION_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_GEOMETRY_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_FRAGMENT_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_COMPUTE_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_TRANSFORM_FEEDBACK_VARYING} |
     * | {@see GL46::GL_OFFSET}                               | {@see GL46::GL_UNIFORM}, {@see GL46::GL_BUFFER_VARIABLE},
     * {@see GL46::GL_TRANSFORM_FEEDBACK_VARYING}                                                                                                                                                                                                                                                                                                                                      |
     ...
     * | {@see GL46::GL_BUFFER_BINDING}                       | {@see GL46::GL_UNIFORM_BLOCK}, {@see GL46::GL_ATOMIC_COUNTER_BUFFER},
     * {@see GL46::GL_SHADER_STORAGE_BLOCK},
     * {@see GL46::GL_TRANSFORM_FEEDBACK_BUFFER}                                                                                                                                                                                                                                                                                     |
     * | {@see GL46::GL_BUFFER_DATA_SIZE}                     | {@see GL46::GL_UNIFORM_BLOCK}, {@see GL46::GL_ATOMIC_COUNTER_BUFFER},
     * {@see GL46::GL_SHADER_STORAGE_BLOCK}                                                                                                                                                                                                                                                                                                                                |
     * | {@see GL46::GL_NUM_ACTIVE_VARIABLES}                 | {@see GL46::GL_UNIFORM_BLOCK}, {@see GL46::GL_ATOMIC_COUNTER_BUFFER},
     * {@see GL46::GL_SHADER_STORAGE_BLOCK},
     * {@see GL46::GL_TRANSFORM_FEEDBACK_BUFFER}                                                                                                                                                                                                                                                                                     |
     * | {@see GL46::GL_ACTIVE_VARIABLES}                     | {@see GL46::GL_UNIFORM_BLOCK}, {@see GL46::GL_ATOMIC_COUNTER_BUFFER},
     * {@see GL46::GL_SHADER_STORAGE_BLOCK},
     * {@see GL46::GL_TRANSFORM_FEEDBACK_BUFFER}                                                                                                                                                                                                                                                                                     |
     * | {@see GL46::GL_REFERENCED_BY_VERTEX_SHADER}          | {@see GL46::GL_UNIFORM}, {@see GL46::GL_UNIFORM_BLOCK},
     * {@see GL46::GL_ATOMIC_COUNTER_SHADER}, {@see GL46::GL_BUFFER},
     * {@see GL46::GL_SHADER_STORAGE_BLOCK}, {@see GL46::GL_BUFFER_VARIABLE},
     * {@see GL46::GL_PROGRAM_INPUT}, {@see GL46::GL_PROGRAM_OUTPUT}                                                                                                                                                                               |
     * | {@see GL46::GL_REFERENCED_BY_TESS_CONTROL_SHADER}    | {@see GL46::GL_UNIFORM}, {@see GL46::GL_UNIFORM_BLOCK},
     * {@see GL46::GL_ATOMIC_COUNTER_SHADER}, {@see GL46::GL_BUFFER},
     * {@see GL46::GL_SHADER_STORAGE_BLOCK}, {@see GL46::GL_BUFFER_VARIABLE},
     * {@see GL46::GL_PROGRAM_INPUT}, {@see GL46::GL_PROGRAM_OUTPUT}                                                                                                                                                                               |
     * | {@see GL46::GL_REFERENCED_BY_TESS_EVALUATION_SHADER} | {@see GL46::GL_UNIFORM}, {@see GL46::GL_UNIFORM_BLOCK},
     * {@see GL46::GL_ATOMIC_COUNTER_SHADER}, {@see GL46::GL_BUFFER},
     * {@see GL46::GL_SHADER_STORAGE_BLOCK}, {@see GL46::GL_BUFFER_VARIABLE},
     * {@see GL46::GL_PROGRAM_INPUT}, {@see GL46::GL_PROGRAM_OUTPUT}                                                                                                                                                                               |
     * | {@see GL46::GL_REFERENCED_BY_GEOMETRY_SHADER}        | {@see GL46::GL_UNIFORM}, {@see GL46::GL_UNIFORM_BLOCK},
     * {@see GL46::GL_ATOMIC_COUNTER_SHADER}, {@see GL46::GL_BUFFER},
     * {@see GL46::GL_SHADER_STORAGE_BLOCK}, {@see GL46::GL_BUFFER_VARIABLE},
     * {@see GL46::GL_PROGRAM_INPUT}, {@see GL46::GL_PROGRAM_OUTPUT}                                                                                                                                                                               |
     * | {@see GL46::GL_REFERENCED_BY_FRAGMENT_SHADER}        | {@see GL46::GL_UNIFORM}, {@see GL46::GL_UNIFORM_BLOCK},
     * {@see GL46::GL_ATOMIC_COUNTER_SHADER}, {@see GL46::GL_BUFFER},
     * {@see GL46::GL_SHADER_STORAGE_BLOCK}, {@see GL46::GL_BUFFER_VARIABLE},
     * {@see GL46::GL_PROGRAM_INPUT}, {@see GL46::GL_PROGRAM_OUTPUT}                                                                                                                                                                               |
     * | {@see GL46::GL_REFERENCED_BY_COMPUTE_SHADER}         | {@see GL46::GL_UNIFORM}, {@see GL46::GL_UNIFORM_BLOCK},
     * {@see GL46::GL_ATOMIC_COUNTER_SHADER}, {@see GL46::GL_BUFFER},
     * {@see GL46::GL_SHADER_STORAGE_BLOCK}, {@see GL46::GL_BUFFER_VARIABLE},
     * {@see GL46::GL_PROGRAM_INPUT}, {@see GL46::GL_PROGRAM_OUTPUT}                                                                                                                                                                               |
     * | {@see GL46::GL_NUM_COMPATIBLE_SUBROUTINES}           | {@see GL46::GL_VERTEX_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_TESS_CONTROL_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_TESS_EVALUATION_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_GEOMETRY_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_FRAGMENT_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_COMPUTE_SUBROUTINE_UNIFORM}                                                                                                                                                      |
     * | {@see GL46::GL_COMPATIBLE_SUBROUTINES}               | {@see GL46::GL_VERTEX_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_TESS_CONTROL_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_TESS_EVALUATION_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_GEOMETRY_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_FRAGMENT_SUBROUTINE_UNIFORM},
     ...
     * | {@see GL46::GL_LOCATION}                             | {@see GL46::GL_UNIFORM}, {@see GL46::GL_PROGRAM_INPUT},
     * {@see GL46::GL_PROGRAM_OUTPUT},
     * {@see GL46::GL_VERTEX_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_TESS_CONTROL_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_TESS_EVALUATION_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_GEOMETRY_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_FRAGMENT_SUBROUTINE_UNIFORM},
     ...
     * For the property {@see GL46::GL_NAME_LENGTH}, a single integer
     * identifying the length of the name string associated with an active
     * variable, interface block, or subroutine is written to $params. The
     * name length includes a terminating null character.
     *
     * For the property {@see GL46::GL_TYPE}, a single integer identifying
     * the type of an active variable is written to $params. The integer
     * returned is one of the values found in table 2.16.
     *
     * For the property {@see GL46::GL_ARRAY_SIZE}, a single integer
     * identifying the number of active array elements of an active variable
     * is written to $params. The array size returned is in units of the type
     * associated with the property {@see GL46::GL_TYPE}. For active
     * variables not corresponding to an array of basic types, the value zero
     * is written to $params.
     *
     * For the property {@see GL46::GL_BLOCK_INDEX}, a single integer
     * identifying the index of the active interface block containing an
     * active variable is written to $params. If the variable is not the
     * member of an interface block, the value -1 is written to $params.
     *
     * For the property {@see GL46::GL_OFFSET}, a single integer identifying
     * the offset of an active variable is written to $params. For variables
     * in the {@see GL46::GL_UNIFORM} and {@see GL46::GL_BUFFER_VARIABLE}
     * interfaces that are backed by a buffer object, the value written is
     * the offset of that variable relative to the base of the buffer range
     * holding its value. For variables in the
     * {@see GL46::GL_TRANSFORM_FEEDBACK_VARYING} interface, the value
     * written is the offset in the transform feedback buffer storage
     ...
     * the `xfb_offset` layout qualifier or assigned according to the
     * variables position in the list of strings passed to
     * {@see GL46::glTransformFeedbackVaryings}. Offsets are expressed in
     * basic machine units. For all variables not recorded in transform
     * feedback mode, including the special names `"gl_NextBuffer"`,
     * `"gl_SkipComponents1"`, `"gl_SkipComponents2"`,
     * `"gl_SkipComponents3"`, and `"gl_SkipComponents4"`, -1 is written to
     * $params.
     *
     * For the property {@see GL46::GL_ARRAY_STRIDE}, a single integer
     * identifying the stride between array elements in an active variable is
     * written to $params. For active variables declared as an array of basic
     * types, the value written is the difference, in basic machine units,
     * between the offsets of consecutive elements in an array. For active
     * variables not declared as an array of basic types, zero is written to
     * $params. For active variables not backed by a buffer object, -1 is
     * written to $params, regardless of the variable type.
     *
     * For the property {@see GL46::GL_MATRIX_STRIDE}, a single integer
     * identifying the stride between columns of a column-major matrix or
     * rows of a row-major matrix is written to $params. For active variables
     * declared a single matrix or array of matrices, the value written is
     * the difference, in basic machine units, between the offsets of
     * consecutive columns or rows in each matrix. For active variables not
     * declared as a matrix or array of matrices, zero is written to $params.
     * For active variables not backed by a buffer object, -1 is written to
     * $params, regardless of the variable type.
     *
     * For the property {@see GL46::GL_IS_ROW_MAJOR}, a single integer
     * identifying whether an active variable is a row-major matrix is
     * written to $params. For active variables backed by a buffer object,
     * declared as a single matrix or array of matrices, and stored in
     * row-major order, one is written to $params. For all other active
     * variables, zero is written to $params.
     *
     * For the property {@see GL46::GL_ATOMIC_COUNTER_BUFFER_INDEX}, a single
     * integer identifying the index of the active atomic counter buffer
     * containing an active variable is written to $params. If the variable
     * is not an atomic counter uniform, the value -1 is written to $params.
     *
     * For the property {@see GL46::GL_BUFFER_BINDING}, to index of the
     * buffer binding point associated with the active uniform block, shader
     * storage block, atomic counter buffer or transform feedback buffer is
     * written to $params.
     *
     * For the property {@see GL46::GL_BUFFER_DATA_SIZE}, then the
     * implementation-dependent minimum total buffer object size, in basic
     * machine units, required to hold all active variables associated with
     * an active uniform block, shader storage block, or atomic counter
     * buffer is written to $params. If the final member of an active shader
     * storage block is array with no declared size, the minimum buffer size
     * is computed assuming the array was declared as an array with one
     * element.
     *
     * For the property {@see GL46::GL_NUM_ACTIVE_VARIABLES}, the number of
     * active variables associated with an active uniform block, shader
     * storage block, atomic counter buffer or transform feedback buffer is
     * written to $params.
     *
     * For the property {@see GL46::GL_ACTIVE_VARIABLES}, an array of active
     * variable indices associated with an active uniform block, shader
     * storage block, atomic counter buffer or transform feedback buffer is
     * written to $params. The number of values written to $params for an
     * active resource is given by the value of the property
     * {@see GL46::GL_NUM_ACTIVE_VARIABLES} for the resource.
     *
     * For the properties {@see GL46::GL_REFERENCED_BY_VERTEX_SHADER},
     * {@see GL46::GL_REFERENCED_BY_TESS_CONTROL_SHADER},
     * {@see GL46::GL_REFERENCED_BY_TESS_EVALUATION_SHADER},
     * {@see GL46::GL_REFERENCED_BY_GEOMETRY_SHADER},
     * {@see GL46::GL_REFERENCED_BY_FRAGMENT_SHADER}, and
     * {@see GL46::GL_REFERENCED_BY_COMPUTE_SHADER}, a single integer is
     * written to $params, identifying whether the active resource is
     * referenced by the vertex, tessellation control, tessellation
     * evaluation, geometry, or fragment shaders, respectively, in the
     * program object. The value one is written to $params if an active
     ...
     * at least one variable referenced by the corresponding shader.
     * Otherwise, the value zero is written to $params.
     *
     * For the property {@see GL46::GL_TOP_LEVEL_ARRAY_SIZE}, a single
     * integer identifying the number of active array elements of the
     * top-level shader storage block member containing to the active
     * variable is written to $params. If the top-level block member is not
     * declared as an array, the value one is written to $params. If the
     * top-level block member is an array with no declared size, the value
     * zero is written to $params.
     *
     * For the property {@see GL46::GL_TOP_LEVEL_ARRAY_STRIDE}, a single
     * integer identifying the stride between array elements of the top-level
     * shader storage block member containing the active variable is written
     * to $params. For top-level block members declared as arrays, the value
     ...
     * written to $params.
     *
     * For the property {@see GL46::GL_LOCATION}, a single integer
     * identifying the assigned location for an active uniform, input,
     * output, or subroutine uniform variable is written to $params. For
     * input, output, or uniform variables with locations specified by a
     * layout qualifier, the specified location is used. For vertex shader
     * input or fragment shader output variables without a layout qualifier,
     * the location assigned when a program is linked is written to $params.
     * For all other input and output variables, the value -1 is written to
     * $params. For uniforms in uniform blocks, the value -1 is written to
     * $params.
     *
     * For the property {@see GL46::GL_LOCATION_INDEX}, a single integer
     * identifying the fragment color index of an active fragment shader
     * output variable is written to $params. If the active variable is an
     * output for a non-fragment shader, the value -1 will be written to
     * $params.
     *
     * For the property {@see GL46::GL_IS_PER_PATCH}, a single integer
     * identifying whether the input or output is a per-patch attribute. If
     * the active variable is a per-patch attribute (declared with the
     * `patch` qualifier), the value one is written to $params; otherwise,
     * the value zero is written to $params.
     *
     * For the property {@see GL46::GL_LOCATION_COMPONENT}, a single integer
     ...
     * variables with a component specified by a `layout` qualifier, the
     * specified component is written. For all other input and output
     * variables, the value zero is written.
     *
     * For the property {@see GL46::GL_TRANSFORM_FEEDBACK_BUFFER_INDEX}, a
     * single integer identifying the index of the active transform feedback
     * buffer associated with an active variable is written to $params. For
     * variables corresponding to the special names `"gl_NextBuffer"`,
     * `"gl_SkipComponents1"`, `"gl_SkipComponents2"`,
     * `"gl_SkipComponents3"`, and `"gl_SkipComponents4"`, -1 is written to
     * $params.
     *
     * For the property {@see GL46::GL_TRANSFORM_FEEDBACK_BUFFER_STRIDE}, a
     * single integer identifying the stride, in basic machine units, between
    ...
    /**
     * {@see GL46::glGetProgramResourceLocation} returns the location
     * assigned to the variable named $name in interface $programInterface of
     * program object $program. $program must be the name of a program that
     * has been linked successfully. $programInterface must be one of
     * {@see GL46::GL_UNIFORM}, {@see GL46::GL_PROGRAM_INPUT},
     * {@see GL46::GL_PROGRAM_OUTPUT},
     * {@see GL46::GL_VERTEX_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_TESS_CONTROL_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_TESS_EVALUATION_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_GEOMETRY_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_FRAGMENT_SUBROUTINE_UNIFORM},
     * {@see GL46::GL_COMPUTE_SUBROUTINE_UNIFORM}, or
     * {@see GL46::GL_TRANSFORM_FEEDBACK_BUFFER}.
     *
     ...
     * are the same locations returned when querying the
     * {@see GL46::GL_LOCATION} and {@see GL46::GL_LOCATION_INDEX} resource
     * properties.
     *
     * A string provided to {@see GL46::glGetProgramResourceLocation} is
     ...
     * {@see GL46::glGetProgramResourceLocation} returns the location
     * assigned to that element. If it specifies the base name of an array,
     * it identifies the resources associated with the first element of the
     * array.
     *
    ...
    /**
     * {@see GL46::glGetProgramResourceLocationIndex} returns the fragment
     * color index assigned to the variable named $name in interface
     ...
     * must be {@see GL46::GL_PROGRAM_OUTPUT}.
     *
     * The value -1 will be returned if an error occurs, if $name does not
     * identify an active variable on $programInterface, or if $name
     * identifies an active variable that does not have a valid location
     ...
     * properties.
     *
     * A string provided to {@see GL46::glGetProgramResourceLocationIndex} is
     * considered to match an active variable if:
     *
     *  -  the string exactly matches the name of the active variable
     *  -  if the string identifies the base name of an active array, where the
    ...
    /**
     * {@see GL46::glShaderStorageBlockBinding}, changes the active shader
     ...
     * value of {@see GL46::GL_MAX_SHADER_STORAGE_BUFFER_BINDINGS}. If
     * successful, {@see GL46::glShaderStorageBlockBinding} specifies that
     * $program will use the data store of the buffer object bound to the
     * binding point $storageBlockBinding to read and write the values of the
     * buffer variables in the shader storage block identified by
     * $storageBlockIndex.
     *
    ...
    /**
     * {@see GL46::glTextureView} initializes a texture object as an alias,
     * or view of another texture object, sharing some or all of the parent
     * texture's data store with the initialized texture. $texture specifies
     * a name previously reserved by a successful call to
     * {@see GL46::glGenTextures} but that has not yet been bound or given a
     * target. $target specifies the target for the newly initialized texture
     * and must be compatible with the target of the parent texture, given in
     ...
     * | {@see GL46::GL_TEXTURE_CUBE_MAP}             | {@see GL46::GL_TEXTURE_CUBE_MAP}, {@see GL46::GL_TEXTURE_2D},
     * {@see GL46::GL_TEXTURE_2D_ARRAY},
     ...
     * | {@see GL46::GL_TEXTURE_CUBE_MAP_ARRAY}       | {@see GL46::GL_TEXTURE_CUBE_MAP}, {@see GL46::GL_TEXTURE_2D},
     * {@see GL46::GL_TEXTURE_2D_ARRAY},
     * {@see GL46::GL_TEXTURE_CUBE_MAP_ARRAY} |
     * | {@see GL46::GL_TEXTURE_2D_MULTISAMPLE}       | {@see GL46::GL_TEXTURE_2D_MULTISAMPLE},
     * {@see GL46::GL_TEXTURE_MULTISAMPLE_ARRAY}                                                      |
     * | {@see GL46::GL_TEXTURE_2D_MULTISAMPLE_ARRAY} | {@see GL46::GL_TEXTURE_2D_MULTISAMPLE},
     * {@see GL46::GL_TEXTURE_MULTISAMPLE_ARRAY}                                                      |
     * The value of {@see GL46::GL_TEXTURE_IMMUTABLE_FORMAT} for $origtexture
     * must be {@see GL46::GL_TRUE}. After initialization, $texture inherits
     * the data store of the parent texture, $origtexture and is usable as a
     * normal texture object with target $target. Data in the shared store is
     * reinterpreted with the new internal format specified by
     * $internalformat. $internalformat must be compatible with the internal
     * format of the parent texture as specified in the following table:
     *
     * | 128-bit                    | {@see GL46::GL_RGBA32F}, {@see GL46::GL_RGBA32UI},
     * {@see GL46::GL_RGBA32I}                                                                                                                                                                                                                                                                                                                                                                  |
     * | 96-bit                     | {@see GL46::GL_RGB32F}, {@see GL46::GL_RGB32UI},
     * {@see GL46::GL_RGB32I}                                                                                                                                                                                                                                                                                                                                                                     |
     * | 64-bit                     | {@see GL46::GL_RGBA16F}, {@see GL46::GL_RG32F},
     * {@see GL46::GL_RGBA16UI}, {@see GL46::GL_RG32UI},
     * {@see GL46::GL_RGBA16I}, {@see GL46::GL_RG32I},
     * {@see GL46::GL_RGBA16}, {@see GL46::GL_RGBA16_SNORM}                                                                                                                                                                                                                                      |
     * | 48-bit                     | {@see GL46::GL_RGB16}, {@see GL46::GL_RGB16_SNORM},
     * {@see GL46::GL_RGB16F}, {@see GL46::GL_RGB16UI},
     * {@see GL46::GL_RGB16I}                                                                                                                                                                                                                                                                                                                 |
     * | 32-bit                     | {@see GL46::GL_RG16F}, {@see GL46::GL_R11F_G11F_B10F},
     * {@see GL46::GL_R32F}, {@see GL46::GL_RGB10_A2UI},
     * {@see GL46::GL_RGBA8UI}, {@see GL46::GL_RG16UI},
     * {@see GL46::GL_R32UI}, {@see GL46::GL_RGBA8I}, {@see GL46::GL_RG16I},
     * {@see GL46::GL_R32I}, {@see GL46::GL_RGB10_A2}, {@see GL46::GL_RGBA8},
     * {@see GL46::GL_RG16}, {@see GL46::GL_RGBA8_SNORM},
     * {@see GL46::GL_RG16_SNORM}, {@see GL46::GL_SRGB8_ALPHA8},
     * {@see GL46::GL_RGB9_E5} |
     * | 24-bit                     | {@see GL46::GL_RGB8}, {@see GL46::GL_RGB8_SNORM},
     * {@see GL46::GL_SRGB8}, {@see GL46::GL_RGB8UI}, {@see GL46::GL_RGB8I}                                                                                                                                                                                                                                                                                                                      |
     * | 16-bit                     | {@see GL46::GL_R16F}, {@see GL46::GL_RG8UI}, {@see GL46::GL_R16UI},
     * {@see GL46::GL_RG8I}, {@see GL46::GL_R16I}, {@see GL46::GL_RG8},
     * {@see GL46::GL_R16}, {@see GL46::GL_RG8_SNORM},
     * {@see GL46::GL_R16_SNORM}                                                                                                                                                                                                                              |
     * | 8-bit                      | {@see GL46::GL_R8UI}, {@see GL46::GL_R8I}, {@see GL46::GL_R8},
     * {@see GL46::GL_R8_SNORM}                                                                                                                                                                                                                                                                                                                                                     |
     * | {@see GL46::GL_RGTC1_RED}  | {@see GL46::GL_COMPRESSED_RED_RGTC1},
     * {@see GL46::GL_COMPRESSED_SIGNED_RED_RGTC1}                                                                                                                                                                                                                                                                                                                                                           |
     * | {@see GL46::GL_RGTC2_RG}   | {@see GL46::GL_COMPRESSED_RG_RGTC2},
     * {@see GL46::GL_COMPRESSED_SIGNED_RG_RGTC2}                                                                                                                                                                                                                                                                                                                                                             |
     * | {@see GL46::GL_BPTC_UNORM} | {@see GL46::GL_COMPRESSED_RGBA_BPTC_UNORM},
     * {@see GL46::GL_COMPRESSED_SRGB_ALPHA_BPTC_UNORM}                                                                                                                                                                                                                                                                                                                                                |
     * | {@see GL46::GL_BPTC_FLOAT} | {@see GL46::GL_COMPRESSED_RGB_BPTC_SIGNED_FLOAT},
     * {@see GL46::GL_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT}                                                                                                                                                                                                                                                                                                                                        |
     ...
     * which of those slices and levels are considered part of the texture.
     ...
     * texture.
     *
     * If the new texture's target is {@see GL46::GL_TEXTURE_CUBE_MAP}, the
     * clamped $numlayers must be equal to 6. If the new texture's target is
     * {@see GL46::GL_TEXTURE_CUBE_MAP_ARRAY}, then $numlayers counts
     * layer-faces rather than layers, and the clamped $numlayers must be a
     * multiple of 6. If the new texture's target is
     * {@see GL46::GL_TEXTURE_CUBE_MAP} or
     * {@see GL46::GL_TEXTURE_CUBE_MAP_ARRAY}, the width and height of the
     * original texture's levels must be equal.
     *
     * When the original texture's target is
     * {@see GL46::GL_TEXTURE_CUBE_MAP}, the layer parameters are interpreted
     * in the same order as if it were a
     * {@see GL46::GL_TEXTURE_CUBE_MAP_ARRAY} with 6 layer-faces.
     *
     * If $target is {@see GL46::GL_TEXTURE_1D}, {@see GL46::GL_TEXTURE_2D},
     * {@see GL46::GL_TEXTURE_3D}, {@see GL46::GL_TEXTURE_RECTANGLE}, or
     * {@see GL46::GL_TEXTURE_2D_MULTISAMPLE}, $numlayers must equal 1.
     *
     ...
     * the original texture has a {@see GL46::GL_TEXTURE_2D_ARRAY} target and
     * its width is greater than {@see GL46::GL_MAX_CUBE_MAP_TEXTURE_SIZE},
     * an error will be generated if {@see GL46::glTextureView} is called to
     * create a {@see GL46::GL_TEXTURE_CUBE_MAP} view.
     *
     * Texture commands that take a $level or $layer parameter, such as
     * {@see GL46::glTexSubImage2D}, interpret that parameter to be relative
     * to the view of the texture. i.e. the mipmap level of the data store
     * that would be updated via {@see GL46::glTexSubImage2D} would be the
     * sum of $level and the value of {@see GL46::GL_TEXTURE_VIEW_MIN_LEVEL}.
     *
    ...
    /**
     * {@see GL46::glBindVertexBuffer} and
     * {@see GL46::glVertexArrayVertexBuffer} bind the buffer named $buffer
     * to the vertex buffer binding point whose index is given by
     * $bindingindex. {@see GL46::glBindVertexBuffer} modifies the binding of
     * the currently bound vertex array object, whereas
     * {@see GL46::glVertexArrayVertexBuffer} allows the caller to specify ID
     * of the vertex array object with an argument named $vaobj, for which
     * the binding should be modified. $offset and $stride specify the offset
     * of the first element within the buffer and the distance between
     * elements within the buffer, respectively, and are both measured in
     * basic machine units. $bindingindex must be less than the value of
     * {@see GL46::GL_MAX_VERTEX_ATTRIB_BINDINGS}. $offset and $stride must
     * be greater than or equal to zero. If $buffer is zero, then any buffer
     ...
     * creates a new state vector, initialized with a zero-sized memory
     * buffer and comprising all the state and with the same initial values
     * as in case of {@see GL46::glBindBuffer}. $buffer is then attached to
     * the specified $bindingindex of the vertex array object.
     *
    ...
    /**
     * {@see GL46::glDebugMessageControl} controls the reporting of debug
     * messages generated by a debug context. The parameters $source, $type
     * and $severity form a filter to select messages from the pool of
     * potential messages generated by the GL.
     *
     * $source may be {@see GL46::GL_DEBUG_SOURCE_API},
     * {@see GL46::GL_DEBUG_SOURCE_WINDOW_SYSTEM_},
     * {@see GL46::GL_DEBUG_SOURCE_SHADER_COMPILER},
     * {@see GL46::GL_DEBUG_SOURCE_THIRD_PARTY},
     * {@see GL46::GL_DEBUG_SOURCE_APPLICATION},
     * {@see GL46::GL_DEBUG_SOURCE_OTHER} to select messages generated by
     * usage of the GL API, the window system, the shader compiler, third
     * party tools or libraries, explicitly by the application or by some
     * other source, respectively. It may also take the value
     * {@see GL46::GL_DONT_CARE}. If $source is not {@see GL46::GL_DONT_CARE}
     * then only messages whose source matches $source will be referenced.
     *
     * $type may be one of {@see GL46::GL_DEBUG_TYPE_ERROR},
     * {@see GL46::GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR},
     * {@see GL46::GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR},
     * {@see GL46::GL_DEBUG_TYPE_PORTABILITY},
     * {@see GL46::GL_DEBUG_TYPE_PERFORMANCE},
     * {@see GL46::GL_DEBUG_TYPE_MARKER},
     * {@see GL46::GL_DEBUG_TYPE_PUSH_GROUP},
     * {@see GL46::GL_DEBUG_TYPE_POP_GROUP}, or
     * {@see GL46::GL_DEBUG_TYPE_OTHER} to indicate the type of messages
     * describing GL errors, attempted use of deprecated features, triggering
     * of undefined behavior, portability issues, performance notifications,
     * markers, group push and pop events, and other types of messages,
     * respectively. It may also take the value {@see GL46::GL_DONT_CARE}. If
     * $type is not {@see GL46::GL_DONT_CARE} then only messages whose type
     * matches $type will be referenced.
     *
     * $severity may be one of {@see GL46::GL_DEBUG_SEVERITY_LOW},
     * {@see GL46::GL_DEBUG_SEVERITY_MEDIUM}, or
     * {@see GL46::GL_DEBUG_SEVERITY_HIGH} to select messages of low, medium
     * or high severity messages or to
     * {@see GL46::GL_DEBUG_SEVERITY_NOTIFICATION} for notifications. It may
     * also take the value {@see GL46::GL_DONT_CARE}. If $severity is not
     * {@see GL46::GL_DONT_CARE} then only messages whose severity matches
     * $severity will be referenced.
     *
     * $ids contains a list of $count message identifiers to select specific
     * messages from the pool of available messages. If $count is zero then
     * the value of $ids is ignored. Otherwise, only messages appearing in
     * this list are selected. In this case, $source and $type may not be
     * {@see GL46::GL_DONT_CARE} and $severity must be
     * {@see GL46::GL_DONT_CARE}.
     *
     * If $enabled is {@see GL46::GL_TRUE} then messages that match the
     * filter formed by $source, $type, $severity and $ids are enabled.
    ...
    /**
     * {@see GL46::glDebugMessageInsert} inserts a user-supplied message into
     * the debug output queue. $source specifies the source that will be used
     * to classify the message and must be
     * {@see GL46::GL_DEBUG_SOURCE_APPLICATION} or
     * {@see GL46::GL_DEBUG_SOURCE_THIRD_PARTY}. All other sources are
     * reserved for use by the GL implementation. $type indicates the type of
     * the message to be inserted and may be one of
     * {@see GL46::GL_DEBUG_TYPE_ERROR},
     * {@see GL46::GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR},
     * {@see GL46::GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR},
     * {@see GL46::GL_DEBUG_TYPE_PORTABILITY},
     * {@see GL46::GL_DEBUG_TYPE_PERFORMANCE},
     ...
     * {@see GL46::GL_DEBUG_TYPE_PUSH_GROUP},
     * {@see GL46::GL_DEBUG_TYPE_POP_GROUP}, or
     * {@see GL46::GL_DEBUG_TYPE_OTHER}. $severity indicates the severity of
     * the message and may be {@see GL46::GL_DEBUG_SEVERITY_LOW},
     * {@see GL46::GL_DEBUG_SEVERITY_MEDIUM},
     * {@see GL46::GL_DEBUG_SEVERITY_HIGH} or
     * {@see GL46::GL_DEBUG_SEVERITY_NOTIFICATION}. $id is available for
     * application defined use and may be any value. This value will be
    ...
    /**
     * {@see GL46::glDebugMessageCallback} sets the current debug output
     * callback function to the function whose address is given in $callback.
     * The callback function should have the following prototype (in C), or
     * be otherwise compatible with such a prototype:
     *
     * <code>
     ...
     * API functions. In most cases this is defined as `APIENTRY`, although
     * it will vary depending on platform, language and compiler.
     *
     ...
     * with the message, and $length set to the length of debug message whose
     * character string is in the array pointed to by $message $userParam
     * will be set to the value passed in the $userParam parameter to the
     * most recent call to {@see GL46::glDebugMessageCallback}.
     *
    ...
    /**
     * {@see GL46::glGetDebugMessageLog} retrieves messages from the debug
     ...
     * written into up to $count elements of the array. If $severities is not
     * NULL then the severity of each message is written into up to $count
     ...
     * into the remaining space in $messageLog then the function terminates
     * and returns the number of messages written so far, which may be zero.
     *
     * If {@see GL46::glGetDebugMessageLog} returns zero then no messages are
     * present in the debug log, or there was not enough space in $messageLog
     * to retrieve the first message in the queue. If $messageLog is NULL
     * then no messages are written and the value of $bufSize is ignored.
     *
    ...
    /**
     * {@see GL46::glPushDebugGroup} pushes a debug group described by the
     * string $message into the command stream. The value of $id specifies
     * the ID of messages generated. The parameter $length contains the
     * number of characters in $message. If $length is negative, it is
     * implied that $message contains a null terminated string. The message
     * has the specified $source and $id, the $type
     * {@see GL46::GL_DEBUG_TYPE_PUSH_GROUP}, and $severity
     * {@see GL46::GL_DEBUG_SEVERITY_NOTIFICATION}. The GL will put a new
     * debug group on top of the debug group stack which inherits the control
     * of the volume of debug output of the debug group previously residing
     * on the top of the debug group stack. Because debug groups are strictly
    ...
    /**
     * {@see GL46::glPopDebugGroup} pops the active debug group. After
     * popping a debug group, the GL will also generate a debug output
     * message describing its cause based on the $message string, the source
     * $source, and an ID $id submitted to the corresponding
     * {@see GL46::glPushDebugGroup} command.
     * {@see GL46::GL_DEBUG_TYPE_PUSH_GROUP} and
     * {@see GL46::GL_DEBUG_TYPE_POP_GROUP} share a single namespace for
     * message $id. $severity has the value
     * {@see GL46::GL_DEBUG_SEVERITY_NOTIFICATION}. The $type has the value
     * {@see GL46::GL_DEBUG_TYPE_POP_GROUP}. Popping a debug group restores
    ...
    /**
     * {@see GL46::glObjectLabel} labels the object identified by $name
     * within the namespace given by $identifier. $identifier must be one of
     * {@see GL46::GL_BUFFER}, {@see GL46::GL_SHADER},
     * {@see GL46::GL_PROGRAM}, {@see GL46::GL_VERTEX_ARRAY},
     * {@see GL46::GL_QUERY}, {@see GL46::GL_PROGRAM_PIPELINE},
     * {@see GL46::GL_TRANSFORM_FEEDBACK}, {@see GL46::GL_SAMPLER},
     * {@see GL46::GL_TEXTURE}, {@see GL46::GL_RENDERBUFFER},
     * {@see GL46::GL_FRAMEBUFFER}, to indicate the namespace containing the
     * names of buffers, shaders, programs, vertex array objects, query
     * objects, program pipelines, transform feedback objects, samplers,
     ...
     * $length is negative, it is implied that $label contains a
     * null-terminated string. If $label is NULL, any debug label is
     * effectively removed from the object.
     *
    ...
    /**
     * {@see GL46::glGetObjectLabel} retrieves the label of the object
     * identified by $name within the namespace given by $identifier.
     * $identifier must be one of {@see GL46::GL_BUFFER},
     * {@see GL46::GL_SHADER}, {@see GL46::GL_PROGRAM},
     * {@see GL46::GL_VERTEX_ARRAY}, {@see GL46::GL_QUERY},
     * {@see GL46::GL_PROGRAM_PIPELINE}, {@see GL46::GL_TRANSFORM_FEEDBACK},
     * {@see GL46::GL_SAMPLER}, {@see GL46::GL_TEXTURE},
     * {@see GL46::GL_RENDERBUFFER}, {@see GL46::GL_FRAMEBUFFER}, to indicate
     * the namespace containing the names of buffers, shaders, programs,
     * vertex array objects, query objects, program pipelines, transform
     * feedback objects, samplers, textures, renderbuffers and frame buffers,
     * respectively.
     *
     * $label is the address of a string that will be used to store the
     * object label. $bufSize specifies the number of characters in the array
     * identified by $label. $length contains the address of a variable which
     * will receive the number of characters in the object label. If $length
     * is NULL, then it is ignored and no data is written. Likewise, if
     * $label is NULL, or if $bufSize is zero then no data is written to
     * $label.
     *
    ...
    /**
     * {@see GL46::glObjectPtrLabel} labels the sync object identified by
     * $ptr.
     *
    ...
    /**
     * {@see GL46::glGetObjectPtrLabel} retrieves the label of the sync
     * object identified by $ptr.
     *
     * $label is the address of a string that will be used to store the
     * object label. $bufSize specifies the number of characters in the array
     * identified by $label. $length contains the address of a variable which
