...
class GL31 extends GL30
{
    ...
    /**
     * {@see GL46::glGetActiveUniformsiv} queries the value of the parameter named $pname for each of the uniforms
     ...
     *
     * If $pname is {@see GL46::GL_UNIFORM_TYPE}, then an array identifying the types of uniforms specified by the
     * corresponding array of $uniformIndices is returned. The returned types can be any of the values from the
     * following table:         Returned Symbolic Contant     Shader Uniform Type        {@see GL46::GL_FLOAT}
     * {@see GL46::float}     {@see GL46::GL_FLOAT_VEC2}   {@see GL46::vec2}     {@see GL46::GL_FLOAT_VEC3}
     * {@see GL46::vec3}     {@see GL46::GL_FLOAT_VEC4}   {@see GL46::vec4}     {@see GL46::GL_DOUBLE}
     * {@see GL46::double}     {@see GL46::GL_DOUBLE_VEC2}   {@see GL46::dvec2}     {@see GL46::GL_DOUBLE_VEC3}
     * {@see GL46::dvec3}     {@see GL46::GL_DOUBLE_VEC4}   {@see GL46::dvec4}     {@see GL46::GL_INT}
     * {@see GL46::int}     {@see GL46::GL_INT_VEC2}   {@see GL46::ivec2}     {@see GL46::GL_INT_VEC3}
     * {@see GL46::ivec3}     {@see GL46::GL_INT_VEC4}   {@see GL46::ivec4}     {@see GL46::GL_UNSIGNED_INT}
     * {@see GL46::unsigned int}     {@see GL46::GL_UNSIGNED_INT_VEC2}   {@see GL46::uvec2}
     * {@see GL46::GL_UNSIGNED_INT_VEC3}   {@see GL46::uvec3}     {@see GL46::GL_UNSIGNED_INT_VEC4}
     * {@see GL46::uvec4}     {@see GL46::GL_BOOL}   {@see GL46::bool}     {@see GL46::GL_BOOL_VEC2}
     * {@see GL46::bvec2}     {@see GL46::GL_BOOL_VEC3}   {@see GL46::bvec3}     {@see GL46::GL_BOOL_VEC4}
     * {@see GL46::bvec4}     {@see GL46::GL_FLOAT_MAT2}   {@see GL46::mat2}     {@see GL46::GL_FLOAT_MAT3}
     * {@see GL46::mat3}     {@see GL46::GL_FLOAT_MAT4}   {@see GL46::mat4}     {@see GL46::GL_FLOAT_MAT2x3}
     * {@see GL46::mat2x3}     {@see GL46::GL_FLOAT_MAT2x4}   {@see GL46::mat2x4}     {@see GL46::GL_FLOAT_MAT3x2}
     * {@see GL46::mat3x2}     {@see GL46::GL_FLOAT_MAT3x4}   {@see GL46::mat3x4}     {@see GL46::GL_FLOAT_MAT4x2}
     * {@see GL46::mat4x2}     {@see GL46::GL_FLOAT_MAT4x3}   {@see GL46::mat4x3}     {@see GL46::GL_DOUBLE_MAT2}
     * {@see GL46::dmat2}     {@see GL46::GL_DOUBLE_MAT3}   {@see GL46::dmat3}     {@see GL46::GL_DOUBLE_MAT4}
     * {@see GL46::dmat4}     {@see GL46::GL_DOUBLE_MAT2x3}   {@see GL46::dmat2x3}     {@see GL46::GL_DOUBLE_MAT2x4}
     *  {@see GL46::dmat2x4}     {@see GL46::GL_DOUBLE_MAT3x2}   {@see GL46::dmat3x2}
     * {@see GL46::GL_DOUBLE_MAT3x4}   {@see GL46::dmat3x4}     {@see GL46::GL_DOUBLE_MAT4x2}   {@see GL46::dmat4x2}
     *    {@see GL46::GL_DOUBLE_MAT4x3}   {@see GL46::dmat4x3}     {@see GL46::GL_SAMPLER_1D}
     ...
     * {@see GL46::GL_UNSIGNED_INT_SAMPLER_2D_RECT}   {@see GL46::usampler2DRect}
     *
     * If $pname is {@see GL46::GL_UNIFORM_SIZE}, then an array identifying the size of the uniforms specified by the
     * corresponding array of $uniformIndices is returned. The sizes returned are in units of the type returned by a
     * query of {@see GL46::GL_UNIFORM_TYPE}. For active uniforms that are arrays, the size is the number of active
     * elements in the array; for all other uniforms, the size is one.
     *
     * If $pname is {@see GL46::GL_UNIFORM_NAME_LENGTH}, then an array identifying the length, including the
     * terminating null character, of the uniform name strings specified by the corresponding array of
     * $uniformIndices is returned.
     *
     * If $pname is {@see GL46::GL_UNIFORM_BLOCK_INDEX}, then an array identifying the uniform block index of each of
     ...
     *
     * If $pname is {@see GL46::GL_UNIFORM_OFFSET}, then an array of uniform buffer offsets is returned. For uniforms
     ...
     *
     * If $pname is {@see GL46::GL_UNIFORM_ARRAY_STRIDE}, then an array identifying the stride between elements of
     ...
     *
     * If $pname is {@see GL46::GL_UNIFORM_MATRIX_STRIDE}, then an array identifying the stride between columns of a
     ...
     * returned.
     *
     * If $pname is {@see GL46::GL_UNIFORM_IS_ROW_MAJOR}, then an array identifying whether each of the uniforms
     ...
     *
     * If $pname is {@see GL46::GL_UNIFORM_ATOMIC_COUNTER_BUFFER_INDEX}, then an array identifying the active atomic
     ...
     * be passed to {@see GL46::glGetActiveAtomicCounterBufferiv} to query the properties of the associated buffer,
    ...
    /**
     * {@see GL46::glGetUniformBlockIndex} retrieves the index of a uniform block within $program.
     *
     * $program must be the name of a program object for which the command {@see GL46::glLinkProgram} must have been
     * called in the past, although it is not required that {@see GL46::glLinkProgram} must have succeeded. The link
     * could have failed because the number of active uniforms exceeded the limit.
     ...
     *
     * {@see GL46::glGetUniformBlockIndex} returns the uniform block index for the uniform block named
     * $uniformBlockName of $program. If $uniformBlockName does not identify an active uniform block of $program,
     * {@see GL46::glGetUniformBlockIndex} returns the special identifier, {@see GL46::GL_INVALID_INDEX}. Indices of
    ...
    /**
     * Binding points for active uniform blocks are assigned using {@see GL46::glUniformBlockBinding}. Each of a
     * program's active uniform blocks has a corresponding uniform buffer binding point. $program is the name of a
     * program object for which the command {@see GL46::glLinkProgram} has been issued in the past.
     *
     * If successful, {@see GL46::glUniformBlockBinding} specifies that $program will use the data store of the
