...
// extern BOOL wglUseFontBitmaps (HDC hDC, DWORD first, DWORD count, DWORD listBase);
...
// extern BOOL wglUseFontOutlines (HDC hDC, DWORD first, DWORD count, DWORD listBase, FLOAT deviation, FLOAT extrusion, int format, LPGLYPHMETRICSFLOAT lpgmf);
